...
document.querySelectorAll('.continue-btn').forEach((item, i) => {
  if (Number(localStorage.level) === 0) { document.getElementById('level1').classList.add('active'); }
  if (Number(localStorage.level) === 1) { document.getElementById('level2').classList.add('active'); }
  if (Number(localStorage.level) === 2) { document.getElementById('level3').classList.add('active'); }
  if (Number(localStorage.level) === 3) { document.getElementById('level4').classList.add('active'); }
  if (Number(localStorage.level) === 4) { document.getElementById('level5').classList.add('active'); }
  if (Number(localStorage.level) === 5) { document.getElementById('level6').classList.add('active'); }
